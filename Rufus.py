...
versi_rufus = '4.9.2256'
for i in range(3):
    print(i + 1, end=' ')
    while True:
        WinClick(f'Rufus {versi_rufus}', 306, 488) # START
        ...
        if WinGetColor(f'Rufus {versi_rufus}', 95, 442, (6, 176, 37)):
            WinClick(f'Rufus {versi_rufus}', 412, 486) # CANCEL
